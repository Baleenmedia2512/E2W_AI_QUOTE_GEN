...
const ClientInfoFormWithAutocomplete: React.FC<ClientInfoFormWithAutocompleteProps> = ({
  ...
  // NEW: Handle lead selection from autocomplete
  const handleLeadSelect = (lead: LeadSearchResult) => {
    setFormData({
      name: lead.name || '',
      company: '', // Lead table doesn't have company field
      address: lead.address || '',
      gst: '', // Lead table doesn't have gst field
      phone: lead.phone || '',
      email: lead.email || '',
    });
...
export default ClientInfoFormWithAutocomplete;

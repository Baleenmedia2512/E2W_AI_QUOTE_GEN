...
export const ClassicBusiness: React.FC<TemplateProps> = ({
  data,
      ...
      <div className="template-classic-business">
        <div className="classic-container">
          <div
            ...
            className="template-classic-business"
          >
            {/* Letterhead */}
                    ...
                    {quote.items.map((item, index) => {
                      ...
                      return (
                        <tr key={index}>
                          ...
                          {quote.gstEnabled && (
                            <td className="cell-gst-pct">{quote.gstPercentage}%</td>
                          )}
                          {quote.gstEnabled && (
                            <td className="cell-incl">{formatCurrency(itemFinal)}</td>
                          )}
                  ...
                  <div key={item.id} className="terms-section">
                    ...
                    <ol className="terms-list">
                      {item.termsAndConditions
                        ...
                        .filter(Boolean)
                        .map((term, i) => (
                          <li key={i}>{renderTermWithLinks(term)}</li>
                        ))}
                    </ol>
                  </div>
                ) : null,
                      ...
                      <div className="terms-section">
                        ...
                        <ol className="terms-list">
                          {(group.termsAndConditions
                            ...
                            <li key={j}>{renderTermWithLinks(term)}</li>
                          ))}
                        </ol>
                      </div>

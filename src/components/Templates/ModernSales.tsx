...
export const ModernSales: React.FC<TemplateProps> = ({
  data,
  ...
  return (
    <>
      <div
        ...
        className="template-modern-sales"
      >
        {/* Header */}
        <div className="ms-header">
          <div className="ms-header-left">
            {company.logo && <img src={company.logo} alt={company.name} className="ms-logo" />}
                  ...
                  {quote.items.map((item, index) => {
                    ...
                    return (
                      <tr key={index}>
                        ...
                        {quote.gstEnabled && (
                          <td className="ms-cell-gst-pct">{quote.gstPercentage}%</td>
                        )}
                        {quote.gstEnabled && (
                          <td className="ms-cell-incl">{formatCurrency(itemFinal)}</td>
                        )}
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td className="ms-cell-desc">
                                  <strong>{item.description}</strong>
                                  {item.details && (
                                    <div className="ms-item-details">{item.details}</div>
                                  )}
                                </td>
                                <td className="ms-cell-qty">{item.quantity}</td>
                                <td className="ms-cell-rate">{formatCurrency(item.rate)}</td>
                                ...
                                {hasRemarkGroup && (
                                  <td className="ms-cell-remark">{item.remark || ''}</td>
                                )}
                              </tr>
                            );
                          })}

...
export const CorporateMinimal: React.FC<TemplateProps> = ({
  ...
  const parseGSTFromTerms = (terms: string): number => {
    if (terms) {
      const match =
        terms.match(/GST\s+(\d+(?:\.\d+)?)\s*%/i) || terms.match(/(\d+(?:\.\d+)?)\s*%\s*GST/i);
          ...
          <div className="terms-section" style={{ marginTop: '24px' }}>
            ...
            >
              <tbody>
                <tr>
                  <td
                    style={{ padding: '4px 12px 4px 0', fontWeight: '600', whiteSpace: 'nowrap' }}
                  >
                    ICICI Current Acc.
                  </td>
                  <td style={{ padding: '4px 0' }}>: 104005500375</td>
                </tr>
                <tr>
                  <td
                    style={{ padding: '4px 12px 4px 0', fontWeight: '600', whiteSpace: 'nowrap' }}
                  ...
                  <td style={{ padding: '4px 0' }}>: Baleen Media</td>
                </tr>
                <tr>
                  <td
                    style={{ padding: '4px 12px 4px 0', fontWeight: '600', whiteSpace: 'nowrap' }}
                  ...
                  <td style={{ padding: '4px 0' }}>: ICIC0001040</td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  const multiTotal =
    ...
    serviceGroups.reduce(
      (sum, g) => sum + (g.termsAndConditions || quote.termsAndConditions ? 3 : 2),
      0,
    ) +
    1;
            ...
            <>
              ...
              {hasGroupTerms && (
                <div
                  ...
                  className="template-corporate-minimal"
                >
                  <div className="terms-section">
                    <h3
                      className="smart-section-heading"

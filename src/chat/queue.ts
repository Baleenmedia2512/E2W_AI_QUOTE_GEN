...
import { batchResolve, continueBatchQueue, parseServiceSegments } from './funnel/batchResolve';
import type { BatchSegment, IntentOverlay, ProgressiveSession, ProgressiveTurnResult } from './types';
...
export function runBatchTextTurn(
  ...
  return batchResolve(segments, session, services, null);
}
